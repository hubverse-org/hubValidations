...
#> <git repository>: /tmp/Rtmp7oJLAo/file21de5caa44cd/target[@add-file-oracle-output]
...
#> <git repository>: /tmp/Rtmp7oJLAo/file21de5caa44cd/target[@delete-target-dir-files]
...
#> <git repository>: /tmp/Rtmp7oJLAo/file21de5caa44cd/target[@remove-ts-add-oo]
