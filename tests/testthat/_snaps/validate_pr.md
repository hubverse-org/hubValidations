    ...
    Output
      List of 2
       $ hub-config                                  :List of 1
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-config"
       $ hub-baseline/2022-10-22-hub-baseline.parquet:Classes 'hub_validations', 'list'  hidden list of 12
        ..$ file_exists       :List of 4
        ...
        ..- attr(*, "where")= chr "hub-baseline/2022-10-22-hub-baseline.parquet"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
       - attr(*, "warnings")=List of 1
        ..$ :List of 5
        .. ..$ message       : chr "Hub config files modified: 'admin.json', 'model-metadata-schema.json', and 'tasks.json'.\n      Config changes "| __truncated__
...
# validate_pr flags modifications and deletions in PR
    ...
    Output
      List of 5
       ...
       $ team1-goodmodel.yaml                          :Classes 'hub_validations', 'list'  hidden list of 1
        ..$ valid_file_status:List of 6
    ...
    Output
      List of 3
       ...
       $ team1-goodmodel/2022-10-22-team1-goodmodel.csv:List of 24
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "team1-goodmodel/2022-10-22-team1-goodmodel.csv"
       $ team1-goodmodel/2022-10-team1-goodmodel.csv   :Classes 'hub_validations', 'list'  hidden list of 3
        ..$ file_exists      :List of 4
        .. ..$ message       : chr "File exists at path 'model-output/team1-goodmodel/2022-10-team1-goodmodel.csv'. \n "
        .. ..$ where         : 'fs_path' chr "team1-goodmodel/2022-10-team1-goodmodel.csv"
        .. ..$ call          : chr "check_file_exists"
        .. ..$ use_cli_format: logi TRUE
        .. ..- attr(*, "class")= chr [1:5] "check_success" "hub_check" "rlang_message" "message" ...
        ..$ file_name        :List of 6
        .. ..$ message       : chr "File name \"2022-10-team1-goodmodel.csv\" must be valid. \n Could not correctly parse submission metadata."
        .. ..$ trace         : NULL
        .. ..$ parent        : NULL
        .. ..$ where         : 'fs_path' chr "team1-goodmodel/2022-10-team1-goodmodel.csv"
        .. ..$ call          : chr "check_file_name"
        ...
        ..- attr(*, "where")= chr "team1-goodmodel/2022-10-team1-goodmodel.csv"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
       - attr(*, "warnings")=List of 1
        ..$ :List of 5
        .. ..$ message       : chr "Hub config files modified: 'admin.json', 'model-metadata-schema.json', and 'tasks.json'.\n      Config changes "| __truncated__
    ...
    Output
      List of 2
       $ hub-config                                    :List of 1
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-config"
       $ team1-goodmodel/2022-10-22-team1-goodmodel.csv:List of 20
        ..$ file_exists         :List of 4
        .. ..$ message       : chr "File exists at path 'model-output/team1-goodmodel/2022-10-22-team1-goodmodel.csv'. \n "
        .. ..$ where         : 'fs_path' chr "team1-goodmodel/2022-10-22-team1-goodmodel.csv"
        .. ..$ call          : chr "check_file_exists"
