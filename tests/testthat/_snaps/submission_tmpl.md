# submission_tmpl works correctly
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2023-01-30"))
    Output
...
---
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2023-01-16"))
    Output
      tibble [3,132 x 7] (S3: tbl_df/tbl/data.frame)
...
---
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2023-01-16", required_vals_only = TRUE))
    Output
...
---
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2022-10-01"))
    Output
...
---
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2022-10-01", required_vals_only = TRUE,
        complete_cases_only = FALSE))
    Message
...
---
    ...
    Code
      str(submission_tmpl(hub_con, round_id = "2022-10-29", required_vals_only = TRUE,
        complete_cases_only = FALSE))
    Message
      ! Column "location" whose values are all optional included as all `NA` column.
      i See Hub's 'tasks.json' file or <hub_connection> attribute "config_tasks" for
