# validate_submission works
    ...
    Output
      List of 1
       $ team1-goodmodel/2022-10-08-team1-goodmodel.csv:List of 20
...
---
    ...
    Output
      List of 1
       $ team1-goodmodel/2022-10-15-team1-goodmodel.csv:Classes 'hub_validations', 'list'  hidden list of 1
...
---
    ...
    Output
      List of 1
       $ team1-goodmodel/2022-10-15-hub-baseline.csv:Classes 'hub_validations', 'list'  hidden list of 11
        ..$ file_exists       :List of 4
        ...
        .. ..$ use_cli_format: logi TRUE
        .. ..- attr(*, "class")= chr [1:5] "check_error" "hub_check" "rlang_error" "error" ...
        ..- attr(*, "where")= chr "team1-goodmodel/2022-10-15-hub-baseline.csv"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
...
---
    ...
    Output
      List of 1
       $ team1-goodmodel/2022-10-08-team1-goodmodel.csv:Classes 'hub_validations', 'list'  hidden list of 10
        ..$ file_exists       :List of 4
        .. ..$ message       : chr "File exists at path 'model-output/team1-goodmodel/2022-10-08-team1-goodmodel.csv'. \n "
        .. ..$ where         : chr "team1-goodmodel/2022-10-08-team1-goodmodel.csv"
        .. ..$ call          : chr "check_file_exists"
...
# validate_submission submission within window works
    ...
    Code
      str(validate_submission(hub_path, file_path = file_path)[[file_path]][[
        "submission_time"]])
    Output
      List of 4
    ...
    Output
      List of 2
       $ hub-config                              :List of 1
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-config"
       $ hub-baseline/2023-04-24-hub-baseline.csv:List of 20
        ..$ file_exists         :List of 4
        ...
        .. ..- attr(*, "class")= chr [1:5] "check_info" "hub_check" "rlang_message" "message" ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-baseline/2023-04-24-hub-baseline.csv"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
    ...
    Output
      List of 2
       $ hub-config                              :List of 1
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-config"
       $ team-model/2023-11-26-team-model.parquet:List of 20
        ..$ file_exists         :List of 4
        ...
        .. ..- attr(*, "class")= chr [1:5] "check_info" "hub_check" "rlang_message" "message" ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "team-model/2023-11-26-team-model.parquet"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
    ...
    Output
      List of 2
       $ hub-config                              :List of 1
        ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "hub-config"
       $ team-model/2023-11-19-team-model.parquet:List of 20
        ..$ file_exists         :List of 4
        ...
        .. ..- attr(*, "class")= chr [1:5] "check_info" "hub_check" "rlang_message" "message" ...
        ..- attr(*, "class")= chr [1:2] "hub_validations" "list"
        ..- attr(*, "where")= chr "team-model/2023-11-19-team-model.parquet"
       - attr(*, "class")= chr [1:2] "hub_validations_collection" "list"
...
# validate_submission handles overriding output type id data type correctly.
    ...
    Code
      validate_submission(hub_path = test_path("testdata/hub-it"), file_path = file_path_1,
      skip_submit_window_check = TRUE)[[file_path_1]][["col_types"]]
    Output
      <error/check_failure>
      Error:
...
---
    ...
    Code
      validate_submission(hub_path = test_path("testdata/hub-it"), file_path = file_path_2,
      skip_submit_window_check = TRUE)[[file_path_2]][["col_types"]]
    Output
      <message/check_success>
      Message:
      Column data types match hub schema.
...
---
    ...
    Code
      ...
      file_path = file_path, skip_submit_window_check = TRUE, derived_task_ids = "target_end_date")[[
        file_path]][c("valid_vals", "req_vals", "value_col_valid", "spl_n",
        "spl_compound_taskid_set", "spl_compound_tid", "spl_non_compound_tid")]
    Message
      
      -- flu-base/2022-10-22-flu-base.csv ----
...
# validate_submission works with v4 flusight (contains derived_task_ids)
    ...
    Message
      ...
      -- hub-baseline/2023-05-08-hub-baseline.parquet ----
