...
The function takes a relative path, relative to the model output directory, as argument `file_path`, performs a series of standard validation checks and returns their results in the form of a `hub_validations_collection` S3 class object.
...
You can check whether your file will overall pass validation checks by passing the validation results to `check_for_errors()`. 
