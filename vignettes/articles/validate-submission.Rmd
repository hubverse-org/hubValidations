...
The function takes a relative path, relative to the model output directory, as argument `file_path`, performs a series of validation checks and returns their results in the form of a `hub_validations` S3 class object.
...
For more details on the structure of `<hub_validations>` objects, see `vignette("hub-validations-class")`.
