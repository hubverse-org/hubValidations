...
arrow::read_csv_arrow(system.file("check_table.csv", package = "hubValidations")) %>%
  ...
  knitr::kable(caption = "Details of available optional checks or checks requiring configuration for `validate_model_data()`.") %>%
...
arrow::read_csv_arrow(system.file("check_table.csv", package = "hubValidations")) %>%
  ...
  knitr::kable(caption = "Details of available optional checks or checks requiring configuration for `validate_model_metadata()`.") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  column_spec(1, bold = TRUE)
```
